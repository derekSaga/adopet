...
class PetModel(BASE):
    ...
    specie_id = mapped_column(types.UUID, ForeignKey(AnimalSpecieModel.id, ondelete="CASCADE"))
    status_id = mapped_column(types.UUID, ForeignKey(StatusModel.id, ondelete="CASCADE"))
